...
//forma que hicimos con pablo, diferencias null, y return 
// let alicia = [ 10, 80, 75];
// let bob = [ 90, 20, 25];
// function encontrarPersona(a,b){
//     let puntosAlicia = null;
//     let puntosBob = null;
//     for (let i = 0; i < a.length; i++) {
//     if(a[i] > b[i]){
//         puntosAlicia = puntosAlicia + 1;
...
//     }
//     if (puntosAlicia > puntosBob){
//         return "Alicia ganó, con" + puntosAlicia + "puntos";
//     }else if(puntosAlicia < puntosBob){
//         return "Bob ganó, con" + puntosBob + "puntos";
//     }else{
//         console.log("que se realice un nuevo concurso");
//     }
//     }
// let ganador = encontrarPersona(alicia,bob);
// console.log(ganador);
